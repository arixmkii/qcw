...
Version `v28.0.1`. Rebuilt for Windows amd64 platform.

#### `docker-compose`

Version `v2.33.1`. Rebuilt for Windows amd64 platform.
...
Version `v0.0.6`. Rebuilt for Windows amd64 platform.
...
Version `10.0.0-rc0` with 2 patch sets from QEMU mailing list:
...
### 2. Key pairs created with official Lima instance will lack Unix permissions and will be rejected
