...
* Update Alpine to 3.23.4 and add Lima required tools.

#### `docker-cli`

Version `29.4.1`. Rebuilt for Windows amd64 platform.

#### `docker-compose`

Version `5.1.3`. Rebuilt for Windows amd64 platform.
...
Version `2.1.2-beta.0` with 2 patch sets:
* Support WSL2 as a replacement for msys2/cygwin;
* Keep QEMU `kernel-irqchip` enabled.
