...
* Update Alpine to 3.24.1 and add Lima required tools.
...
Version `5.4.0`. Rebuilt for Windows amd64 platform.
...
Version `6.0.2` with 2 patch sets:
...
Version `11.1.0` with 5 patch sets:
...
* more WHPX fixes https://lists.nongnu.org/archive/html/qemu-devel/2026-08/msg01769.html.
