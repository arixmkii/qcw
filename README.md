...
* Update Alpine to 3.22.2 and add Lima required tools.

#### `docker-cli`

Version `29.0.1`. Rebuilt for Windows amd64 platform.

#### `docker-compose`

Version `2.40.3`. Rebuilt for Windows amd64 platform.
...
Version `0.0.8`. Rebuilt for Windows amd64 platform with 1 patch set:
* Package as Lima dependcies.

#### `Lima`

Version `1.2.2` with 1 patch set:
* Support WSL2 as a replacement for msys2/cygwin.

#### `Podman`

Version `5.7.0` with 3 patch sets:
...
Version `10.2.0-rc1` with 6 patch sets:
