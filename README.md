...
Version `28.5.1`. Rebuilt for Windows amd64 platform.

#### `docker-compose`

Version `2.40.0`. Rebuilt for Windows amd64 platform.
...
Version `5.6.2` with 3 patch sets:
...
Version `10.1.1` with 4 patch sets:
