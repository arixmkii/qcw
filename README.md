...
Version `2.36.0`. Rebuilt for Windows amd64 platform.
...
Development main branch from revision `353be898ff96553f1222897aa175c14262bbefed` with 1 patch set:
...
Version `10.0.0` with 3 patch sets:
